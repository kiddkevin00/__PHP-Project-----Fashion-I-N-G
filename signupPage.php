	...
	<body>
		<div class="container">
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="form-signin" role="form">
				...
				Comment: <span class="error" id="comment-hint"></span> 
				<textarea id="comment" name="comment" onkeyup="getHint(this.value)" class="form-control" rows="5" cols="40" placeholder="I'd like to have more feeature like.."> <?php echo $comment; ?> </textarea>
